...
class Naive_trainer:
    ...
    def train(self):
        if self.parameter['reload_ckpt'] is not None:
            state_dict_file = os.path.join(self.ckpt_dir, 'state_dict_' + self.parameter['reload_ckpt'] + '.ckpt')
            ...
            print("No state dict having to reload from!")
        ...
        for e in range(self.epoch):
            ...
            #     print(f"stop at {e} for {patience} epochs, loss hasn't been better.")
            #     print(
            #         f"best loss is {best_loss}, best epoch is {best_e}")
            ...
            if e % self.print_epoch == 0:
                ...
                print("up to now: best epo is:", best_e)
